...
public class AuthController {
    ...
    @PostMapping("/google")
    public UsuarioResponseDTO loginGoogle(@RequestBody GoogleLoginRequestDTO dto) {
    ...
    public UsuarioResponseDTO verificarCodigo(@RequestBody VerificarCodigoRequestDTO dto) {
        return service.verificarCodigo(dto);
    }

    @PostMapping("/reenviar-codigo")
    public java.util.Map<String, String> reenviarCodigo(@RequestBody VerificarCodigoRequestDTO dto) {
        service.reenviarCodigo(dto.getEmail());

        return java.util.Map.of("mensagem", "Código reenviado com sucesso.");
    }
}